...
class StatStatics(StatBase):
    ...
    def record(self, result):
        ...
        tmp_syscall['timestamp'] = str(result["startTime"]) if self._straceOptions["havePointer"] else 0
...
if __name__ == "__main__":
    ...
    s = StraceAnalysiser("/home/az/gitproject/ContainerEscapeDetection/data/syscall_log/runc_cpt.log0000")
    s.handle()
